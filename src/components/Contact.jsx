      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary mb-8 leading-relaxed">
            I’m currently open to new opportunities and collaborations. Got a project idea, a question, or just want to connect? Feel free to reach out — my inbox is always open, and I’ll do my best to get back to you soon!
          </p>
          <a
