      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary leading-relaxed">
            Hello! I’m Atchayaa — a curious and creative software developer who enjoys turning ideas into real, functional products. From fixing bugs to building features, I love solving problems through code. I've worked on projects using Java, Python, C, and front-end tools like HTML, CSS, and JavaScript. I'm always up for learning new technologies and finding smarter ways to build cool, user-friendly stuff.
          </p>
